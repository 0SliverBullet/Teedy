...
create cached table T_SIGNUP_USER_REQUEST ( SIG_ID_C varchar(36) not null, SIG_USERNAME_C varchar(50) not null, SIG_PASSWORD_C varchar(60) not null, SIG_CREATEDATE_D datetime not null, SIG_ACCEPTDATE_D datetime, SIG_REJECTDATE_D datetime, SIG_DELETEDATE_D datetime, primary key (SIG_ID_C) );
